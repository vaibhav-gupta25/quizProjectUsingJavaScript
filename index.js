...
const questions = [
  ...
  {
    title: "In CSS, h1 can be called as ?",
    options: [
      "Selector",
      "Value",
      "Attribute",
...
{
  title: "CSS padding property is used for ?",
  options: [
    "Border",
    "Space",
    "Margin",
...
function init() {
  document.body.innerHTML = `
        <h1 class="quiz-heading">Lets take the Challenge. Quizzer!!</h1>
        <div class="app-body">
            <h1 class="answer-key">Result status!</h1>
